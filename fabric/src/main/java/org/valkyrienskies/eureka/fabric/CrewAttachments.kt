...
object CrewAttachments {
     ...
     */
    private val SLOTS: AttachmentType<Int> = AttachmentRegistry.create(
        ResourceLocation.fromNamespaceAndPath(EurekaMod.MOD_ID, "crew_slots")
    ) { it.persistent(Codec.INT).copyOnDeath() }
