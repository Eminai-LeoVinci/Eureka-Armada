...
class CannonBlockEntity(pos: BlockPos, state: BlockState) :
     ...
     *
     * [readyAt] is an absolute game tick, so it only means anything against the clock it was written by.
     * A stamp further ahead than one whole reload cannot be this gun being hot; it means the WORLD clock
