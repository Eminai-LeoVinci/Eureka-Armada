...
object ShipwrightProfession {
    ...
    @JvmField
    val POI_ID: Identifier = Identifier.fromNamespaceAndPath(EurekaMod.MOD_ID, "shipwrights_bench")
    ...
    val PROFESSION_KEY: ResourceKey<VillagerProfession> = ResourceKey.create(
        ...
        Identifier.fromNamespaceAndPath(EurekaMod.MOD_ID, "shipwright")
    )
    ...
    fun registerProfession() {
        Registry.register(
            ...
            PROFESSION_KEY,
            VillagerProfession(
                Component.translatable("entity.${EurekaMod.MOD_ID}.villager.shipwright"),
