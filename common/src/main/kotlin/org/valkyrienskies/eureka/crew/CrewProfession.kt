...
object CrewProfession {
    ...
    @JvmField
    val POI_ID: ResourceLocation = ResourceLocation.fromNamespaceAndPath(EurekaMod.MOD_ID, "ship_helm")
    ...
    val PROFESSION_KEY: ResourceKey<VillagerProfession> = ResourceKey.create(
        ...
        ResourceLocation.fromNamespaceAndPath(EurekaMod.MOD_ID, "crewman")
    )
