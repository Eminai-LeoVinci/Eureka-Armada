...
object CrewProfession {
    ...
    @JvmField
    val POI_ID: Identifier = Identifier.fromNamespaceAndPath(EurekaMod.MOD_ID, "ship_helm")
    ...
    val PROFESSION_KEY: ResourceKey<VillagerProfession> = ResourceKey.create(
        ...
        Identifier.fromNamespaceAndPath(EurekaMod.MOD_ID, "crewman")
    )
    ...
    fun helmBlocks(): Array<Block> = arrayOf(
        ...
        EurekaBlocks.PALE_OAK_SHIP_HELM.get(),
    ...
    fun registerProfession() {
        Registry.register(
            ...
            PROFESSION_KEY,
            VillagerProfession(
                Component.translatable("entity.${EurekaMod.MOD_ID}.villager.crewman"),
